#include "LightSourceData.h"
 ...
 LightSourceData::PointLightSource::PointLightSource ( int lightId , float lightPositionX , float lightPositionY , float lightPositionZ ,
 float diffuseIntensityR , float diffuseIntensityG , float diffuseIntensityB ,
 float specularIntensityR , float specularIntensityG , float specularIntensityB ):mLightId ( lightId )
 {
 ...
 void LightSourceData::PointLightSource::ApplyIntensity ( ) const{
	RenderingGlobalRoutines::ApplyPointLightIntensity ( mLightId , mDiffuseIntensity , mSpecularIntensity);
 }
